...
public class LeftArmSlimOverlay extends LimbCube {
    ...
    public LeftArmSlimOverlay(float scale) {
        super(3.1764708f * scale, 12.705883f * scale, 4.2352943f * scale, 5.5f * scale, 2.0f * scale, 0.0f * scale,
                ...
                -0.5f, 10.0f, -10.0f,
                0.333f, 20.0f, -20.0f);
        float slimWidthRatio = 3.1764708f / 4.2352943f;
        this.leftArmSlimOverlayTexCoordinates = new float[] {
                ...
                0.875f, 1.0f, 0.875f, 0.90625f, 0.875f + 0.0625f * slimWidthRatio, 0.90625f, 0.875f + 0.0625f * slimWidthRatio, 1.0f,
                0.875f, 0.90625f, 0.875f, 0.8125f, 0.875f + 0.0625f * slimWidthRatio, 0.8125f, 0.875f + 0.0625f * slimWidthRatio, 0.90625f,
                0.75f, 1.0f, 0.75f, 0.90625f, 0.75f + 0.0625f * slimWidthRatio, 0.90625f, 0.75f + 0.0625f * slimWidthRatio, 1.0f,
                0.75f, 0.90625f, 0.75f, 0.8125f, 0.75f + 0.0625f * slimWidthRatio, 0.8125f, 0.75f + 0.0625f * slimWidthRatio, 0.90625f,
